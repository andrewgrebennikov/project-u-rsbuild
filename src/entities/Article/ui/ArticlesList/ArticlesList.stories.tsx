...
import { ArticlesList as ArticleListComponent } from './ArticlesList';
...
const articles: Article[] = [
  ...
  },
  {
    ...
    title: 'Python news',
    subtitle: 'Что нового в JS за 2022 год?',
    img: 'http://localhost:3000/images/pyton.png',
    views: 1022,
...
export const ArticlesListLoading: Story = {
  args: {
    isLoading: true,
  },
};

export const ArticlesListGrid: Story = {
  args: {
    articles,
...
export const ArticlesListGridLoading: Story = {
  args: {
    view: ArticlesView.GRID,
    isLoading: true,
  },
...
export const ArticlesListError: Story = {
  args: {
    error: '',
  },
};
